...
A resource assessment is done for fresh water supply in the Greater Accra Region. This includes demand forecasts, supply estimates (from surface water, groundwater, rainwater harvesting, and waste water recycling) as well as planned water supply infrastructure expansions.

### 2.1.1 Regional Water Demand

The Greater Accra Metropolitan Area (GAMA) has a population of between 3.4 and 3.9 million and is projected to grow to between 7.3 and 16.3 million by 2030 (SWITCH EU, 2011). In this region, it has been estimated that only 25% of residents enjoy a 24-hour water supply. About 30% have an average of 12 hours service every day for five days a week. Another 35% have service for two days each week while the remaining residents on the outskirts of Accra are completely without access to piped water supplies (Water Aid, 2005). 99% of all water produced is from the utility system, but only about 50% of the population has access to the utility services – the remaining depend on services providers who, in turn, get water from the utility system at a higher cost. Currently, the amount of water produced is only 70-80% of the required supply (Ministry of Water Resources, 2007) and the region faces rapid population growth.
...
The majority of the current water supply in the metropolitan region is taken from surface water sources, which are imported from regions outside of the city boundaries: the Weija Lake on the Densu River and the Volta Lake on the Volta River (marked “Kpong” in map).
...
Another possibility is transporting groundwater from surrounding areas. Volta Basin groundwater in more northern areas is currently utilized and is relatively abundant in supply (Martin & Niesen, 2005). However, there is little rational of using these resources as opposed to existing Volta surface water resources. Similarly, exploitation of regional aquifers such as the Ghana-Togo-Benin coastal aquifer has little apparent advantage over existing surface water resources given the transport distance that would be required.
...
### 2.1.5 Wastewater Recycling

Use of recycled wastewater for irrigation, industrial and other non-drinking water uses is way to conserve fresh water resources. Recycled water can also be used to replenish sensitive ecosystems that are left vulnerable when water is diverted for urban or rural needs. In coastal areas, recycled water helps recharge groundwater aquifers to prevent the intrusion of saltwater, which can occur when groundwater has been over pumped.
...
for peri-urban agriculture is decreasing rapidly, which decreases the permeability of the surface leading to higher intensity flooding.
...
- Groundwater and many coastal surface water sources are brackish with
salinity levels higher than drinking water standards and high TDS levels.
- The Weija dam is nearing extraction capacity and there are pollution
concerns with many surface water sources in this area.
- The Volta dam requires relatively long transport of water, increasing the
overall cost.
...
The question of whether expanded desalination is an option for the metropolitan region depends on how it compares (economically, environmentally, technically) to alternatives outlined above, such as expanded surface water supply or groundwater withdrawals.

## 2.2 Selection of Optimal Water Supply
...
For example, for water supply groundwater was determined to have the capacity to meet less than 10% of forecasted demand. However, it may be possible in certain cases. It would be assigned a coefficient of 2-3 for the criteria of water supply potential, compared to Lake Volta which has much higher potential (8-9).
...
For a general cost comparison, the highest cost is estimated to be seawater desalination, followed by brackish ground and surface water sources. The Lake Volta supply requires piping transport over 50km and the state of the current pipes is poor and needs expansion/repair. Wastewater recycling would be low in O&M and would reduce flood protection/waste water treatment costs, but desalination would be required if water is taken from wetlands.

There are significant water quality concerns with surface waters, including the current Weija supply, due to waste disposal, untreated effluent and illegal constructions in the catchment basins. This would likely increase treatment costs. The Volta, however, provides good quality water, but currently is more expensive due to transport costs.

<!-- PDF page 41 -->

#### 2.2.2.3 Integrated Water Resource Management

The degree to which the water supply system could be integrated into a regional water management plan is considered. The optimal solution in this regard is to address the problems of flooding and wastewater treatment through wastewater recycling. Also, wetlands used for recycling provide needed habitat for species and maintain source water quality/supply. Similarly, rainwater harvesting can, to a much lesser extent, aid in the control of runoff and flooding. The other options are seen as having a neutral impact from an integrated water management perspective.

#### 2.2.2.4 Security

Security through diversity is a new policy approach to achieve water supply resilience in the face of climate change, drought, population growth, contamination, and infrastructure failure. This entails using a diverse portfolio of water sources, including seawater desalination. Overreliance on a single source of imported supply carries significant risk, particularly for a large city such as Accra, with several million people in the industrial heart of the country.

With regard to water security in the case of Accra, the two existing dams (Weija and Volta) could be an overreliance on dam surface waters for the region, creating both power and water supply security risks. In the event of drought or natural disaster, both supplies could be at risk and do not complement one another. Pipeline transport from Kpong also carries associated risks including rupture or third party damage. Secondary water sources are needed during downtime for repairs or replacement. Adding any other supply sources (other than surface water) is therefore a welcome development. Groundwater supply in Accra may be at risk due to the high levels of unregulated waste disposal and untreated effluent. This risk is mitigated in waste water recycling. In the case of cogeneration of water and power, any option that expands the energy mix beyond hydroelectric is an advantage.

Microbial risk is also a security concern. According to 2011 press reports (Ghana Business News), Kpong has been shut-down due to inadequate disinfection (chlorine pumps not working) and filter backwashing problems. Bleaching power used in the booster stations used to store water from the Kpong carry associated risk of disinfection failure, corrosion, and risk of explosion/fire due to reactivity. Pollutants from human activities such as quarrying, illegal fishing methods, farming and encroachment have reduced the quality of the raw water and consequently affecting the quality of the treated output water meant for consumption.
...
## 2.3 Energy Resource Assessment

A main reason for existing water supply shortages is unreliability of the power supply needed to run pumps and other aspects of the water infrastructure. Adding capacity to the existing water supply without addressing underlying problems in the electrical grid will only exacerbate this problem. In the case of desalination, the high power requirement often makes the co-location of water and energy plants a rational choice. Given this water-energy nexus, an analysis of energy resources is made.

### 2.3.1 Supply & Demand Forecast

For urban and industrial areas, Ghana has been struggling to meet electricity demand. From 1988 to 2002, Ghana’s electricity consumption increased at an average rate of over 8% per annum. With demand expected to grow over 6% annually between now and 2020, additions to thermal generating capacity must been undertaken.

The major source of electricity generation in Ghana has traditionally been hydroelectric, supplemented by oil and gas fired plants. Due to fuel shortages and supply disruptions, frequent blackouts have occurred in the Accra region for both residential and industrial facilities. The OECD has referred to this as a “perennial energy crisis” that hampers economic growth in the country (OECD, 2008). The crisis worsens during the dry season when the hydroelectric dams experience low water levels (Hammond & Kemausuor, 2007). During the 2007 year of drought, it was estimated that power shortages cost the country $1.4 billion in lost economic growth.

In 2011, Ghana Grid Company released a transmission master plan outlining the need for substantial investment to meet a 5,000MW generation and distribution target by 2015. This target would meet domestic demand and also allow Ghana to improve its position as a regional energy exporter. Current and projected generation capacity is summarized in Table 8 below.
...
In terms of regional supplies, the West African Gas Pipeline runs from Nigeria to the Gulf of Guinea, giving costal Ghana ready access to supplies of natural gas. The Economic Commission of West Africa States (ECOWAS) has promoted plans for improved transmission on a regional level. In Ghana, distribution and commercial loses account for about 20% of demand (industry expected level is 3%), due to inadequate transmission capacity. Significant investment in

10 At any given time, an average of 14% generating capacity is shut down for maintenance and entire plants may have to shut down; 20% reserve capacity is considered reasonable and below 17.5% considered precarious supply. The 20% figure was derived from a variety of sources including Taiwan Power Company (www.re.org.tw).

<!-- PDF page 47 -->

transmission infrastructure is also needed, but this topic is not addressed in this report.
...
#### 2.3.2.5 Fossil Fuels

Ghana has proven reserves of natural gas of 22.65 billion cubic meters and there is a current pipeline for natural gas imports from Nigeria through the West African Gas Pipeline which passed adjacent to the proposed site. A feasibility study was recently launched for an offshore floating storage re-gasification unit as the government is pursuing options to fill possible supply shortages from Nigeria by 2013. There is a current National Gas Project which includes immediate plans to process and pipe gas from the Jubilee oil field Phase to the Takoradi Thermal Plants in Aboadze. In April 2012, Ghana signed a $1 Billion loan with China Development Bank which includes plans to expand pipelines and processing capacity. Given these policy commitments, Natural Gas is projected to be the key source in the future energy-mix in the country for decades to come.
...
Biomass is currently the dominant energy source in Ghana due primarily to its domestic use for cooking and other heat applications: 70% of the country’s total energy consumption comes from biomass. An assessment of the biomass availability in Ghana is provided in the literature (Arthur, Baidoo, & Antwi, 2011). With agriculture and forestry as the main industries, widespread biomass energy adoption could help with both energy production and sanitation. Possible
...
Co-combustion is the simultaneous combustion of different fuels. This results in emissions reductions as a result of replacing fossil fuels with biomass and allows for a greater variety of feedstocks including MSW and agricultural residues as

<!-- PDF page 53 -->

well as fossil fuels. It is a proven technology with about 100 such plants operating in Europe.

Similar to straight biomass plants, the transport or distance requirements for large volumes of biomass could prohibit the practicality of a large plant. Successful co- combustion plants often are co-located with the raw material source (eg. wood residues from a processing facility or crops residues from large agriculture operations). Such facilities exist in the interior of the country, but not necessarily on the urban coast where a desalination plant would be located. Therefore, co- location of desalination and co-combustion may not be economic.
...
Energy potential is assessed in terms of capacity that can be generated based on current technology, infrastructure in the country, expertise and available resources in the form of primary energy. It ranges from non-existing (geothermal at 0); high cost or little potential (ocean energy at 2); mid-low potential (solar, 3-4); intermediate potential (wind/biomass, 6); high potential (natural gas/nuclear/co- firing 8-9). While, straight biomass may have high potential for rural areas in the country as a whole, a centralized biomass power plant is seen as a more moderate prospect (6). The high potential options can reach higher generation capacity based on energy density and ample available resources. In the case of natural gas, the significant investments that are planned in expanding capacity make it possible to reach large generating potential.

#### 2.4.2.2 Cost

The cost of electricity is based on available 2011 data in USD/MWh (Energy Information Association, 2011) and ranges from the highest cost (ocean energy) to the lower cost options of natural gas and co-firing. Cost of electricity is a calculation of the cost of generating electricity at the point of connection to a load

<!-- PDF page 56 -->

or electricity grid. It includes the initial capital, discount rate, as well as the costs of continuous operation, fuel, and maintenance.
...
Based on the assigned values, natural gas is the optimal solution for energy generation, followed by co-firing with biomass. Again, the reader should note, this conclusion is based only on the context in question and should not be interpreted as a final conclusion for power generation in Ghana. This conclusion is due to its large potential, preferable economics, and practicality given policy commitment to natural gas infrastructure in the region. Co-firing of MSW or biomass with fossil fuels is also an optimal prospect, but challenges in waste collection and transport could render this option impractical in the immediate term. However, with proper coordination with waste collection or for other generation facilities in the country’s interior, this option is an interesting prospect. Similarly, other forms of renewable energy are certainly possibilities in other locations or circumstances.

<!-- PDF page 59 -->

## 2.5 Selection of the Optimal Desalination System

In the case that seawater or brackish water sources are used, desalination will be required. As outlined in the introduction, a number of possibilities exist for the desalination system including14:
...
The choice of system will depend on a number of factors including type and quality of power available, size and location of the plant, and the budget. Nearly all systems currently being installed outside of the Middle East are based on Reverse Osmosis technology. However, thermal systems (MED, MSF) remain the technology of choice within the Middle East region due to their track record and efficiency when coupled with power generation facilities. Electrodialysis is largely confined to smaller volume, brackish groundwater applications but has been used for larger applications. Research is being undertaken on Forward Osmosis and plants have been successfully established, but limited information is available regarding the commercial viability of this technology15.
...
However, these claims are contested (Kamal, 2008); it is argued that when steam in combined cycle is used for power generation (as opposed to thermal desalination), there is no economic or performance advantages of hybrid systems when building a new plant. Rather, hybrid systems are justified only when retrofitting old systems where boilers or MSF units need to be replaced. For this analysis, hybrid system will not be considered since consensus does not seem conclusive.
...
For the cost of brackish water desalination there is a slight advantage of ED over RO and the cost is proportional to the salinity of the feed water. The cost of thermal cycles varies based on whether or not waste steam is used from a power generation facility. In this case the lower end of the cost range (for MED and MSF) was used, assuming waste steam is available. However, these are conservative estimates as they do not take into account the opportunity cost of low pressure steam that is extracted16. Investment as well as operation and maintenance costs were taken from a reference study (Rujula & Dia, 2010).
...
common to all plants with some variance based on plant type. Specific energy consumption and therefore associated emissions for membrane processes is lower than thermal, thus they are given a slightly higher ranking. The level of brine produced and impact of water intake facilities is assumed to be similar in all cases.
...
The ease with which the technology could be integrated into cogeneration of power and water (using natural gas) was considered. Traditionally in the Middle East, power facilities are coupled with thermal desalination cycles where the low pressure steam can be utilized. (Kamal, 2008) argues thermal generating plants coupled with RO systems produce water more cheaply under all conditions and at all fuel costs, and would provide more operational flexibility than thermal cycles. The conclusion from computer simulations is that withdrawal of low-pressure steam reduces power output of the steam turbine such that it is more efficient to convert low pressure to electricity than to use it for desalination. Another optimization analysis of combined desalination-cogeneration systems also favoured electrically driven RO systems coupled with combined cycle/gas turbines (Ferreira, Balestieri, & Zanardi, 2010). Also, a potential for RO is in the re-use of power plant condenser cooling water and thermal desalination seawater return as feed for RO desalination plants. This option allows for sharing of expensive intake and outfall piping, as discussed in later sections. Therefore, reverse osmosis of seawater is given the highest ranking (7) in terms of cogeneration compatibility.
...
Based on the analysis, Reverse Osmosis of seawater is the optimal desalination technology in this case. This conclusion is consistent with similar multi-criteria analyses applied to cogeneration of water and power. For example, a study to determine the optimal desalination method for an energy-rich Arabian Gulf region concluded that reverse osmosis was most appropriate, despite MSF systems being most commonly built in the region (Hajeeh & Othman, 2005).
...
This can be justified based on some basic conclusions:

- Seawater provides an abundant supply in close proximity to demand (in
contrast to the major freshwater source which would require long-distance piping; seawater desalination diversifies water supply sources which are currently over-dependent on hydroelectric; seawater desalination removes contaminants that are found in coastal water sources due to poor wastewater infrastructure.
- Natural Gas has an existing infrastructure basis and is the cornerstone of
Ghana’s long-term energy plans with the abundant raw material source

<!-- PDF page 65 -->

from Nigeria; many renewable energy sources could present problems with scale and cost at this geographic site and given the short-timeframe; nuclear presents risk complications and uncertainties with regard to long- term uranium supplies.
...
Reverse osmosis seawater desalination powered by natural gas is found to be an optimal system based on comparison of 16 separate criteria and 159 possible technology configurations. There are a number of qualitative assumptions and inherent data limitations in this analytic process; conclusions are only based the particular site in question, current BAT, and sources referenced.
