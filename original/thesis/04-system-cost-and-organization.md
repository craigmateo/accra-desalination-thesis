...
Equations have been restored only where the source text preserved enough information to do so
without speculation. Where exact notation was lost, the original PDF is explicitly identified
...
Present value is used for economic comparison of different plants. All of the costs are discounted to a reference time (usually plant start-up date) to obtain the present value. The cost of electricity (US$/MWh) is calculated from capital recovery, fuel, and fixed/variable operating costs.

> **Equation 4.2.1:** The mathematical expression did not survive PDF-to-text extraction clearly enough to reconstruct with confidence. The variables used in the original equation are defined below; consult the original PDF for the exact typeset form.

Where:

- **TCR** — total capital requirement to be written off: current value of all expenses during planning, procurement, construction, and commissioning, including plant price and interest during construction (US$).
- **Ψ** — annuity factor.
- **P** — rated power output (MW).
- **Teq** — equivalent annual utilization time at rated power output (h/a).
- **YF** — price of fuel (US$/MWh thermal = 3.412 × US$/MMBtu).
- **η** — average plant net efficiency.
- **Ufix** — fixed cost of operation, maintenance, and administration.
- **uvar** — variable cost of operation, maintenance, and repair (US$/MWh).
- **q = 1 + z**, where **z** is the average annual discount rate and **n** is the amortization period in years.
...
> **Equation 4.3.2:** The mathematical expression was lost in PDF-to-text extraction and cannot be reconstructed reliably from the surviving text alone. Consult the original PDF for the exact equation.

<!-- PDF page 115 -->

Where Ci is the cost (USD) of a given item i as a function of product flow Qp and a constant i depending on the item being estimated. The model is only approximately valid for 150,000 m³/day < Qp < 500000 m³/day. Estimates are provided in Table 26 below and calculations found in the Appendix.
...
GWCL Water Tariffs $USD/m³ compared with desalination cost 3
...
USD/m³ Effective October 2012 Billing Cycle 0 Desalination cost
