...
Ministry of Local          Ministry of Finance          Ministry of Water
Government and               and Economic               Resources, Works
Rural Development                Planning                   & Housing

Local Governments                                        Water Directorate

Community Water
Water Resoruces                                          Ghana Water
District Assemblies                                      and Sanitation
Commission                                            Company Limited
Agency

Private Aqua Vitens (PPP) Sector/NGOs
...
The production costs of electricity are expressed in US$/MWh or cents/kWh depending on the capital costs of the project, fuel costs and operation and maintenance costs. Capital costs for a given power plant depends on investment costs, financing structure, interest rate and return on equity and load factor of the plant. Investment costs include the contact price of the plant, interest during construction and cost of realization of the project.

Present value is used for economic comparison of different plants. The all of the costs are discounted to a reference time (usually plant start-up date) to obtain the present value. The cost of electricity US$/MWh is calculated as:

(Equation 4.2.1)

TCR total capital requirement to be written off (current value of all expenses during planning, procurement, construction, and commissioning, such as the price of the plant, interest during construction, etc.) (US$):

Ψ annuity factor: P rated power output in MW Teq equivalent utilization time at rated power output, inhours per annum (h/a)
YF price of fuel (US$/MWh thermal = 3.412 × US$/MBTU)
η average plant net efficiency Ufix fixed cost of operation, maintenance, and administration uvar variable cost of operation, maintenance, and repair (US$/MWh)
q = 1+z
z average discount rate in percent per annum (%/a) n amortization in years
...
desaliation facility

other feedwater (power quality and proximity, variations labour, etc.)
...
Cost data can be derived empirically from existing plants and, where appropriate, used to estimate costs of new builds. Cost of water is generally expressed as $/m3. Construction costs are usually 60-80% of total capital costs and depend on many factors including (AWWA, 2011):
...
Where Ci is the cost (USD) of a given item i as a function of product flow Qp and a constant i depending on the item being estimated. The model is only approximately valid for 150,000 m3/day < Qp < 500000 m3/day. Estimates are provided in Table 26 below and calculations found in the Appendix.
**Table 26:** RO plant capital costs estimate based on data from (AWWA, 2011). Full calculations found in the appendix.
...
Administration, contracting,                      7,700,000
management
...
**Table 27:** RO plant operation costs, own calculations and derived from (AWWA, 2011).
...
Those connected to the GWCL water utility include mainly high and middle income households as well as commercial, industrial, and institutional users. Lower income individuals and households, however, obtain water through unregulated retail venders and tanker trucks (supplied by the utility) or 0.5L water bags (sachet). There are also a number of independent community managed water supply systems what also serve primarily lower income households. Streams and surface water are also used for collection.
...
GWCL Water Tariffs $USD/m3 comparted with desalination cost 3
...
## 0.5 Approved Rate in

USD/m3 Effective October 2012 Billing Cycle 0 Desalination cost

**Figure 50:** Water costs (SWITCH EU, 2011) compared to the estimated SWRO production cost (adapted from GWCL, units converted to USD).
...
Cost of GWCL water and desalination 0.8 0.7 0.6 0.5
## 0.4 GWCL $USD/m3

0.3 Desalination Cost 0.2 0.1 0
Production cost         Net Tariff for GAMA
consumers

**Figure 51:** Utility production cost and current average tariff compared with SWRO production cost estimate. Production costs and tariffs derived from AVRL, SWITCH EU, and Ministry publications (Ghana, Ministry of Water Resources, Works and Housing, 2010); (SWITCH EU, 2011).
